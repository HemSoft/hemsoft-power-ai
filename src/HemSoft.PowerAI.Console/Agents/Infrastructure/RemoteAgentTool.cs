...
internal static class RemoteAgentTool
{
    ...
    [Description("Delegates research tasks to the remote ResearchAgent via A2A protocol. Use for web research and information synthesis.")]
    public static async Task<string> ResearchAgentAsync(
    ...
    public static AITool CreateTool() => AIFunctionFactory.Create(ResearchAgentAsync);
}
