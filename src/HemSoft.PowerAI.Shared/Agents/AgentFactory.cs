...
#pragma warning restore IDISP004
    ...
    public static AIAgent CreateAgent(
        ...
        string name,
        string instructions) =>
        CreateAgentCore(modelId, name, instructions, description: null, tools: null);
    ...
    /// <param name="name">The agent's name.</param>
    /// <param name="instructions">The system instructions for the agent.</param>
    /// <param name="description">Description of the agent's capabilities.</param>
    /// <returns>A configured AIAgent.</returns>
    public static AIAgent CreateAgent(
        string modelId,
        string name,
        string instructions,
        string description) =>
        CreateAgentCore(modelId, name, instructions, description, tools: null);
    ...
    public static AIAgent CreateAgent(
        ...
        string description,
        IList<AITool> tools) =>
        CreateAgentCore(modelId, name, instructions, description, tools);

    private static ChatClientAgent CreateAgentCore(
        string modelId,
        string name,
        string instructions,
        string? description,
